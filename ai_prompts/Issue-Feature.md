...
Example: "Write a description that extract the information from the main-feature branch related to bla.bla,bla...."

# Solution in my words:

[Insert the objective pf the work subset in your own words in here]
...
1. "Success Criteria" in the template below define high level measurable outcomes that determine whether this work subset complete.
1. Add more items to "Success Criteria" and "Completion Checks" if you think it is necessary
1. Do not use sub-bullets under sub-headings in "Success Criteria" and "Completion Checks". All tasks must be at the top level.
...
# Use the template and additionla instructions below to create a Linear issue:
